          <div className="flex gap-3">
            <button onClick={() => setActiveSection('topup')} className="flex-1 py-3 bg-white text-indigo-950 rounded-xl fontimport React, { useState, useEffect, useMemo } from 'react';
